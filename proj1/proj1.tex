...
\author{Jaroslav Kvasnička \\ xkvasn14@stud.fit.vutbr.cz}
\date{}
\begin{document}
...
působí v textu rušivě a unavuje čtenářův zrak.\par
...
\begin{quotation}
	Čím více \textit{druhů}, \textbf{řezů}, {\tiny velikostí},~\textcolor{red}{barev} písma a jiných \textsc{efektů} použijeme,~tím \texttt{profesionálněji}~bude~{\Large \fontfamily{pzc}\selectfont dokument}~vypadat. {\Huge Č}{\huge t}{\Large e}{\large n}ář {\small t}{\scriptsize í}{\tiny m} bude vždy {\Huge \textbf {nadšen!}}
\end{quotation}
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \textit{vlna} od pana Olšáka\footnote{Viz \url{http://petr.olsak.net/ftp/olsak/vlna/}}.
